...
This is the repository for the scripts used in the working paper "More money, more effect? Employment effects of job search services of different intensity" (Junquera, 2025). The main scripts are in the `source` folder. The working paper is available at https://osf.io/preprints/socarxiv/rjshu_v2.

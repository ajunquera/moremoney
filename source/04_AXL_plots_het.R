# ...............................................................................
# ASSEGNO PER IL LAVORO - 04 Plots, heterogeneity
...
cream_D1 <- readRDS("intermediate/script02/cream_D1.RDS")
cream_D2 <- readRDS("intermediate/script02/cream_D2.RDS")
...
## Plots for creaming ----------
### D1 -------------
temp_plot <- ggplot(cream_D1, aes(y = provider)) +

  geom_point(aes(x = point_estimate), size = 1, color = "darkgreen") +
  geom_errorbar(aes(xmin = lower_ci, xmax = upper_ci),
                width = 0.3, linewidth = 0.3, color = "darkgreen",
                orientation = "y") +

  labs(y = "Provider (P)",
       x = expression(paste("Estimate of ", LATE[p], " for ", D[1]))) +

  geom_vline(xintercept = 0, linetype = "dashed", color = "black") +

  scale_x_continuous(breaks = seq(-0.075, 0.075, by = 0.05),
                     limits = c(-0.075, 0.075)) +
  theme_bw() +
  theme(axis.text.x = element_text(size = rel(1.2)),
        axis.text.y = element_text(size = rel(1.2))) +
  ggtitle(expression(paste(Y[p], " = YES ")))

ggsave(filename = "intermediate/script04/plots/creaming_d1.svg",  plot = temp_plot,
       width = 395 / 96, height = 300 / 96, dpi = 96, # Resolución de 96 dpi (píxeles por pulgada)
       units = "in", device = "svg")

### D2 -----------
temp_plot <- ggplot(cream_D2, aes(y = provider)) +
  ...
  labs(y = "Provider (P)",
       x = expression(paste("Estimate of ", LATE[p], " for ", D[2]))) +
...
ggsave(filename = "intermediate/script04/plots/creaming_d2.svg",  plot = temp_plot,
       width = 395 / 96, height = 300 / 96, dpi = 96, # Resolución de 96 dpi (píxeles por pulgada)
       units = "in", device = "svg")
...
### LATE
rsvg_pdf("intermediate/script04/plots/late_d1_yhs.svg",
         "intermediate/script04/plots/late_d1_yhs.pdf")

rsvg_pdf("intermediate/script04/plots/late_d1_yht.svg",
         "intermediate/script04/plots/late_d1_yht.pdf")

rsvg_pdf("intermediate/script04/plots/late_d1_y1.svg",
         "intermediate/script04/plots/late_d1_y1.pdf")

rsvg_pdf("intermediate/script04/plots/late_d1_y2.svg",
         "intermediate/script04/plots/late_d1_y2.pdf")

rsvg_pdf("intermediate/script04/plots/late_d1_y3.svg",
         "intermediate/script04/plots/late_d1_y3.pdf")

rsvg_pdf("intermediate/script04/plots/late_d1_y4.svg",
         "intermediate/script04/plots/late_d1_y4.pdf")


rsvg_pdf("intermediate/script04/plots/late_d2_yhs.svg",
         "intermediate/script04/plots/late_d2_yhs.pdf")

rsvg_pdf("intermediate/script04/plots/late_d2_yht.svg",
         "intermediate/script04/plots/late_d2_yht.pdf")

rsvg_pdf("intermediate/script04/plots/late_d2_y1.svg",
         "intermediate/script04/plots/late_d2_y1.pdf")

rsvg_pdf("intermediate/script04/plots/late_d2_y2.svg",
         "intermediate/script04/plots/late_d2_y2.pdf")

rsvg_pdf("intermediate/script04/plots/late_d2_y3.svg",
         "intermediate/script04/plots/late_d2_y3.pdf")

rsvg_pdf("intermediate/script04/plots/late_d2_y4.svg",
         "intermediate/script04/plots/late_d2_y4.pdf")

## LQTE
rsvg_pdf("intermediate/script04/plots/lqte_d1_y1.svg",
         "intermediate/script04/plots/lqte_d1_y1.pdf")

rsvg_pdf("intermediate/script04/plots/lqte_d1_y2.svg",
         "intermediate/script04/plots/lqte_d1_y2.pdf")

rsvg_pdf("intermediate/script04/plots/lqte_d1_y3.svg",
         "intermediate/script04/plots/lqte_d1_y3.pdf")

rsvg_pdf("intermediate/script04/plots/lqte_d1_y4.svg",
         "intermediate/script04/plots/lqte_d1_y4.pdf")


rsvg_pdf("intermediate/script04/plots/lqte_d2_y1.svg",
         "intermediate/script04/plots/lqte_d2_y1.pdf")

rsvg_pdf("intermediate/script04/plots/lqte_d2_y2.svg",
         "intermediate/script04/plots/lqte_d2_y2.pdf")

rsvg_pdf("intermediate/script04/plots/lqte_d2_y3.svg",
         "intermediate/script04/plots/lqte_d2_y3.pdf")

rsvg_pdf("intermediate/script04/plots/lqte_d2_y4.svg",
         "intermediate/script04/plots/lqte_d2_y4.pdf")


## LATE_j
rsvg_pdf("intermediate/script04/plots/latej_d1_yftc05.svg",
         "intermediate/script04/plots/latej_d1_yftc05.pdf")

rsvg_pdf("intermediate/script04/plots/latej_d1_yftc612.svg",
         "intermediate/script04/plots/latej_d1_yftc612.pdf")

rsvg_pdf("intermediate/script04/plots/latej_d1_yftcm12.svg",
         "intermediate/script04/plots/latej_d1_yftcm12.pdf")

rsvg_pdf("intermediate/script04/plots/latej_d1_yoec.svg",
         "intermediate/script04/plots/latej_d1_yoec.pdf")


rsvg_pdf("intermediate/script04/plots/latej_d2_yftc05.svg",
         "intermediate/script04/plots/latej_d2_yftc05.pdf")

rsvg_pdf("intermediate/script04/plots/latej_d2_yftc612.svg",
         "intermediate/script04/plots/latej_d2_yftc612.pdf")

rsvg_pdf("intermediate/script04/plots/latej_d2_yftcm12.svg",
         "intermediate/script04/plots/latej_d2_yftcm12.pdf")

rsvg_pdf("intermediate/script04/plots/latej_d2_yoec.svg",
         "intermediate/script04/plots/latej_d2_yoec.pdf")

rsvg_pdf("intermediate/script04/plots/creaming_d1.svg",
         "intermediate/script04/plots/creaming_d1.pdf")

rsvg_pdf("intermediate/script04/plots/creaming_d2.svg",
         "intermediate/script04/plots/creaming_d2.pdf")

## Appendix
rsvg_pdf("intermediate/script01/scatterplot.svg",
         "intermediate/script01/scatterplot.pdf")

rsvg_pdf("intermediate/script01/jitterplot.svg",
         "intermediate/script01/jitterplot.pdf")

rsvg_pdf("intermediate/script02/plots/lqte_d1_y1.svg",
         "intermediate/script02/plots/lqte_d1_y1_allquant.pdf")

rsvg_pdf("intermediate/script02/plots/lqte_d1_y2.svg",
         "intermediate/script02/plots/lqte_d1_y2_allquant.pdf")

rsvg_pdf("intermediate/script02/plots/lqte_d1_y3.svg",
         "intermediate/script02/plots/lqte_d1_y3_allquant.pdf")

rsvg_pdf("intermediate/script02/plots/lqte_d1_y4.svg",
         "intermediate/script02/plots/lqte_d1_y4_allquant.pdf")


rsvg_pdf("intermediate/script02/plots/lqte_d2_y1.svg",
         "intermediate/script02/plots/lqte_d2_y1_allquant.pdf")

rsvg_pdf("intermediate/script02/plots/lqte_d2_y2.svg",
         "intermediate/script02/plots/lqte_d2_y2_allquant.pdf")

rsvg_pdf("intermediate/script02/plots/lqte_d2_y3.svg",
         "intermediate/script02/plots/lqte_d2_y3_allquant.pdf")

rsvg_pdf("intermediate/script02/plots/lqte_d2_y4.svg",
...
#### Deeping: Impact on training field ------------
formadomi <- readxl::read_excel("inputdata/unipd_axl estrazione 012023.xlsx",
                        sheet = "Foglio1", col_names = T)

formadomi$id_sf <- paste0(formadomi$ide_soggetto, "_", formadomi$axl_data_attribuzione)
indi_ns_ss1_1_UppSec$id_sf <- paste0(indi_ns_ss1_1_UppSec$ide_soggetto, "_", indi_ns_ss1_1_UppSec$axl_data_attribuzione)

indi_ns_ss1_1_UppSecF <- indi_ns_ss1_1_UppSec %>%
  left_join(., formadomi, by = "id_sf")

## Original
summary(rdrobust(y = indi_ns_ss1_1_UppSecF$flg_prep_ling, x = indi_ns_ss1_1_UppSec$scoringD1_0,
                                         kernel = "triangular",
                                         c = 0, p = 1, bwselect = "mserd",
                                         cluster = NULL))

summary(rdrobust(y = indi_ns_ss1_1_UppSecF$flg_cert_ling, x = indi_ns_ss1_1_UppSec$scoringD1_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))

summary(rdrobust(y = indi_ns_ss1_1_UppSecF$flg_prep_inform, x = indi_ns_ss1_1_UppSec$scoringD1_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL)) # 0.049=p

summary(rdrobust(y = indi_ns_ss1_1_UppSecF$flg_cert_inform, x = indi_ns_ss1_1_UppSec$scoringD1_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))

summary(rdrobust(y = indi_ns_ss1_1_UppSecF$flg_abil_attrezz, x = indi_ns_ss1_1_UppSec$scoringD1_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))

indi_ns_ss1_1_UppSecF %>%
  filter(scoringD1_0 > -0.067 & scoringD1_0 < 0.067) %>%
  group_by(flg_abil_attrezz) %>%
  summarise(post_interval1318_m = mean(post_interval1318))

summary(rdrobust(y = indi_ns_ss1_1_UppSecF$post_interval1318, x = indi_ns_ss1_1_UppSecF$scoringD1_0,
                 covs = indi_ns_ss1_1_UppSecF$flg_cert_ling,
                 kernel = "triangular", c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))
...
summary(rdrobust(y = indi_ns_ss1_1_UppSecF$flg_agg_profess, x = indi_ns_ss1_1_UppSec$scoringD1_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))


summary(rdrobust(y = indi_ns_ss1_1_UppSecF$flg_form_sicur, x = indi_ns_ss1_1_UppSec$scoringD1_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))

## Grouped
indi_ns_ss1_1_UppSecF <- indi_ns_ss1_1_UppSecF %>%
  mutate(language = if_else(flg_prep_ling == 1 | flg_cert_ling == 1, 1, 0),
         digital = if_else(flg_prep_inform == 1 | flg_cert_inform == 1, 1, 0),
         occupational = if_else(flg_abil_attrezz == 1 | flg_agg_profess == 1, 1, 0))

summary(rdrobust(y = indi_ns_ss1_1_UppSecF$language, x = indi_ns_ss1_1_UppSec$scoringD1_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))

summary(rdrobust(y = indi_ns_ss1_1_UppSecF$digital, x = indi_ns_ss1_1_UppSec$scoringD1_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))

summary(rdrobust(y = indi_ns_ss1_1_UppSecF$occupational, x = indi_ns_ss1_1_UppSec$scoringD1_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))
...
#### Deeping: Impact on training field ------------
indi_ns_ss2_1_UppSec$id_sf <- paste0(indi_ns_ss2_1_UppSec$ide_soggetto, "_", indi_ns_ss2_1_UppSec$axl_data_attribuzione)

indi_ns_ss2_1_UppSecF <- indi_ns_ss2_1_UppSec %>%
  left_join(., formadomi, by = "id_sf")

## Original
summary(rdrobust(y = indi_ns_ss2_1_UppSecF$flg_prep_ling, x = indi_ns_ss2_1_UppSecF$scoringD2_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))

summary(rdrobust(y = indi_ns_ss2_1_UppSecF$flg_cert_ling, x = indi_ns_ss2_1_UppSecF$scoringD2_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))

summary(rdrobust(y = indi_ns_ss2_1_UppSecF$flg_prep_inform, x = indi_ns_ss2_1_UppSecF$scoringD2_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL)) # 0.049=p

summary(rdrobust(y = indi_ns_ss2_1_UppSecF$flg_cert_inform, x = indi_ns_ss2_1_UppSecF$scoringD2_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))

summary(rdrobust(y = indi_ns_ss2_1_UppSecF$flg_abil_attrezz, x = indi_ns_ss2_1_UppSecF$scoringD2_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))

summary(rdrobust(y = indi_ns_ss2_1_UppSecF$flg_agg_profess, x = indi_ns_ss2_1_UppSecF$scoringD2_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))

summary(rdrobust(y = indi_ns_ss2_1_UppSecF$flg_form_sicur, x = indi_ns_ss2_1_UppSecF$scoringD2_0,
                 kernel = "triangular",
                 c = 0, p = 1, bwselect = "mserd",
                 cluster = NULL))
...
#write.csv(quality_sex_D1_hetero, 'quality_sex_D1_hetero.csv')
...
#write.csv(quality_sex_D2_hetero, 'quality_sex_D2_hetero.csv')
...
write.csv(quality_age_D1_hetero, 'quality_age_D1_hetero.csv')
...
write.csv(quality_age_D2_hetero, 'quality_age_D2_hetero.csv')
...
write.csv(quality_education_D1_hetero, 'quality_education_D1_hetero.csv')
...
write.csv(quality_education_D2_hetero, 'quality_education_D2_hetero.csv')
...
write.csv(quality_date_D1_hetero, 'quality_date_D1_hetero.csv')
...
#write.csv(quality_date_D2_hetero, 'quality_date_D2_hetero.csv')
...
if (!file.exists("intermediate/script04/B2_pseudotreatments_D1.csv")) {

  write.csv(subgroupD1all, 'intermediate/script04/B2_pseudotreatments_D1.csv')

}

subgroupD1all_compact <- subgroupD1all %>%
  mutate(
    across(Y1:Y4, ~ case_when(
      ...
      row_number() == 7 ~ str_c(.x[row_number() %in% c(7,8)], collapse = "<br>"),
      row_number() == 9 ~ str_c(.x[row_number() %in% c(9,10)], collapse = "<br>"),
      row_number() == 11 ~ str_c(.x[row_number() %in% c(11,12)], collapse = "<br>"),
      row_number() == 13 ~ str_c(.x[row_number() %in% c(13,14)], collapse = "<br>"),
      row_number() == 15 ~ str_c(.x[row_number() %in% c(15,16)], collapse = "<br>"),
      row_number() == 17 ~ str_c(.x[row_number() %in% c(17,18)], collapse = "<br>"),
      TRUE ~ .x
    ))
  ) %>%
  slice(-c(seq(2, 18, 2)))

if (!file.exists("intermediate/script04/subgroupD1all_compact.csv")) {
  write.csv(subgroupD1all_compact, "intermediate/script04/subgroupD1all_compact.csv")
}
...
if (!file.exists("intermediate/script04/B3_pseudotreatments_D2.csv")) {

  write.csv(subgroupD2all, 'intermediate/script04/B3_pseudotreatments_D2.csv')

}

subgroupD2all_compact <- subgroupD2all %>%
  mutate(
    across(Y1:Y4, ~ case_when(
      row_number() == 1 ~ str_c(.x[row_number() %in% c(1,2)], collapse = "<br>"),
      row_number() == 3 ~ str_c(.x[row_number() %in% c(3,4)], collapse = "<br>"),
...
if (!file.exists("intermediate/script04/subgroupD2all_compact.csv")) {
  write.csv(subgroupD2all_compact, "intermediate/script04/subgroupD2all_compact.csv")
}
